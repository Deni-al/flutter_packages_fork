...
- Adds `showManageSubscriptions` to `InAppPurchaseStoreKitPlatformAddition` for StoreKit 2.
- Adds `willAutoRenew` to `InAppPurchaseStoreKitPlatform` for StoreKit 2.
