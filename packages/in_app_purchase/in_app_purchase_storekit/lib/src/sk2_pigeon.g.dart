...
class InAppPurchase2API {
  ...
  Future<bool> isEligibleForIntroOffer(String productId) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.in_app_purchase_storekit.InAppPurchase2API.isEligibleForIntroOffer$pigeonVar_messageChannelSuffix';
  ...
  Future<bool> willAutoRenew(String productId) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.in_app_purchase_storekit.InAppPurchase2API.willAutoRenew$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
